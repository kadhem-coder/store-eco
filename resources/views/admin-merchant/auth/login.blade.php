        ...
        <div class="col-12 d-flex align-items-center justify-content-center">
            <div class="col-md-4 col-10 box-shadow-2 p-0">
                <div class="card border-grey border-lighten-3 m-0">
                    ...
                    @include('admin-merchant.includes.alerts.errors')
                    @include('admin-merchant.includes.alerts.success')
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form-horizontal form-simple" action="{{route('admin.merchant.login')}}" method="post"
                                  novalidate>
                                @csrf
